---
title: "R here"
subtitle: "ที่ที่รวบรวมเวปที่มีประโยชน์เกี่ยวกับอาร์ และอื่น ๆ ที่คิดว่าสำคัญกับการเรียนรู้เกี่ยวกับอาร์ ที่สามารถรวบรวมให้"
---

หน้านี้เป็นหน้าที่บันทึก เกี่ยวกับแหล่งข้อมูลเกี่ยวกับอาร์ ที่สำคัญ

## เครื่องมือเกี่ยวกับอาร์

-   [fontawesome](https://fontawesome.com/v5/search?m=free) และ [`{fontawesome}`](https://github.com/rstudio/fontawesome) เป็น icon น่ารักที่สามารถใส่ ลงไปใน เอกสารที่ knir แล้ว ออกมาน่าอ่าน น่าสนใจขึ้น และไม่ติดลิขสิทธิ์อีกด้วย เช่น `{{< fa yinyang size=2x >}}` {{< fa yinyang >}} {{< fa yin-yang size=2x >}}
